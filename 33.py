...
if __name__=='__main__':
	...
	cowok_pink(f'\n\t{k}忠  {u}WELCOME TO TOOL MR.PS\n\t{k}忠  {u}amaw adaw  Bug/Error Ngiciak awu,Jangan diam ajaw\n\t{k}忠  {u}Doa ka ajaw aku sehat \n\t{k}忠  {u}Dapat bini alap\n\t{k}忠  {u}Aminkah mangku kamu dapat amal \n\t{k}忠  {u}Jangan pacak Coli tula\n\t{k}忠  {u}Kalu Dapat Azab , ingatkah awak tu belum nikah .cuma sekedar informasi ajaw ,kalu gi kepikiran ndak nikah,amaw ndik gila lantak ka la sekendak kaba ,asak ka kaba senang\n\t{k}忠KURANG SENAG DATANGI AKU DI CINTO MANDI {x}')
	time.sleep(3)
	login()
